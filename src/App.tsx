  ...
  return (
    <AppLayout onCycleWallpaper={onCycleWallpaper}>
      {userDataStatus === 'loading' ? (
        ...
        <div className="app-main-layout w-full flex-1 gap-4 lg:gap-6">
          <div className="app-main-layout__left flex min-h-0 flex-col">
            <LeftPanel />
          </div>
          <div className="app-main-layout__center flex min-h-0 min-w-0 flex-col justify-center lg:shrink">
            <CenterColumn />
          </div>
