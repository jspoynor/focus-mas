function PanelSkeleton({ lines = 3 }: { lines?: number }) {
  return (
    <section className="glass-panel min-h-0 overflow-hidden rounded-glass-lg p-6 max-lg:flex-1" aria-hidden="true">
...
export function DataLoadingSkeleton() {
  return (
    <div
      className="flex min-h-0 w-full flex-1 flex-col gap-4 overflow-hidden lg:grid lg:grid-cols-[minmax(0,0.48fr)_minmax(0,2.24fr)_minmax(0,0.48fr)] lg:items-center lg:gap-6"
      role="status"
